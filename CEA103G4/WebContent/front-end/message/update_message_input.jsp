...
<table>
	...
	<tr>
		<td>買家帳號:</td>
		<td><input type="TEXT" name="user_id" size="45" value="<%=messageVO.getUser_id()%>" /></td>
	</tr>
	<tr>
		<td>內容:</td>
		<td><input type="TEXT" name="content" size="45"	value="<%=messageVO.getContent()%>" /></td>
	</tr>
	<tr>
		<td>賣家帳號:</td>
		<td><input type="TEXT" name="seller_id" size="45" value="<%=messageVO.getSeller_id()%>" /></td>
	</tr>
	<tr>
		<td>訊息日期:</td>
...
<script>
        ...
        $('#f_date1').datetimepicker({
           theme: '',              //theme: 'dark',
 		   ...
 		   value: '<%=messageVO.getMessage_time()%>', // value:   new Date(),
