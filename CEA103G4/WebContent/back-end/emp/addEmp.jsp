									...
									<div class="tile-body">
										...
										<FORM METHOD="post"
											...
											<div class="row">
												...
												<div class="col-md-5">
													<div class="form-group">
														<label><i class="fas fa-user-alt"></i>職位:</label> <select
															class="form-control" size="1" name="job">
															<option value="一般管理員"
																${(empVO.job).equals("一般管理員")? 'selected':''}>一般管理員</option>
															<option value="高級管理員"
																${(empVO.job).equals("高級管理員")? 'selected':''}>高級管理員</option>
														</select>
													</div>
												</div>
											</div>
														...
														<div class="form-group authselect">
															<ul>
																<c:forEach var="funVO" items="${funSvc.all}">
																	<li><input class="col-md-3" name="funno"
