...
<!-- 							</label> -->
				...
				<div class="form-group btn-container">
					...
					<button class="btn btn-primary btn-block">
						<i class="fa fa-sign-in fa-lg fa-fw"></i>登入 SIGN IN
					</button>
				</div>
			</form>
			...
			<form METHOD="post" class="forget-form" action="<%=request.getContextPath()%>/loginhandler">
				...
				<div class="form-group">
					...
					<input	id="emails" class="form-control" type="text" placeholder="Email" name="email"><font color=red><b>${errorMsgs.email}</b></font>
				</div>
				<div class="form-group btn-container">
	...
	<script>
		...
		var inputMessage = document.getElementById("emails");
		if(inputMessage === ""){
		Swal.fire({
  			icon: 'error',
  			text: '請輸入Email',	  
