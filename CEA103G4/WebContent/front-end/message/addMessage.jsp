...
<table>
	<tr>
		...
		<td><input type="TEXT" name="user_id" size="45" 
			 value="<%=(messageVO==null)? "abcd01" : messageVO.getUser_id()%>" /></td>
	</tr>
	<tr>
		<td>聊天內容:</td>
		<td><input type="TEXT" name="content" size="45"
			 value="<%=(messageVO==null)? "CONTENT" : messageVO.getContent()%>" /></td>
	</tr>
	<tr>
		<td>賣家帳號:</td>
		<td><input type="TEXT" name="seller_id" size="45"
			 value="<%=(messageVO==null)? "abcd02" : messageVO.getSeller_id()%>" /></td>
	</tr>
	<tr>
		<td>訊息日期:</td>
		<td><input name="message_time" id="f_date1" type="date"></td>
	</tr>
...
<script>
        ...
        $('#f_date1').datetimepicker({
		   ...
		   value: '<%=message_time%>', // value:   new Date(),
